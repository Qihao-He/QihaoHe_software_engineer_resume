...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
        ...
        {Built the high-resolution 6K TV wall for high-density scientific data demonstration, including RAID hard drive mirror backup, hardware assemble, system troubleshoot, and VNC software key-pair.}
        \resumeItemListEnd
