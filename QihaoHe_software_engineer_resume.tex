...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
    \textbf{{\Large Qihao He}} & Email: \href{mailto:qi.he@maine.edu}{qihao.he4@gmail.com}\\
    % & Address: 1730 Mt Rainier Ave, Milpitas, CA 95035\\
    & Address: 3416 Primrose Dr, Rochester Hills, MI 48307\\
    & Work(landline): 2075812247, Mobile: 2075709742\\
    & Linkedin: https://www.linkedin.com/in/qihao-he/
  \end{tabular*}
...
\section{Skills}
 \resumeSubHeadingListStart
    \resumeSubItem{Coding}
      {Java(proficient), Dart, JS, Python, C}
    \resumeSubItem{Front-end}
      {React, Html, css, Tomcat}
    ...
    \resumeSubItem{Generic}
      {Git, Embedded system, benchMarking, Shell/scripting, Perf, Linux Performance counter, Altera Quartus}
