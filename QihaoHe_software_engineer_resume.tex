...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
    ...
    & Address: 3416 Primrose， Rochester Hills, MI 48307, USA\\
...
\section{Skills}
 \resumeSubHeadingListStart
    ...
    \resumeSubItem{Languages}
      {English (Full professional), Chinese (Native), Cantonese (Native), Japanese}
 \resumeSubHeadingListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
        ...
        {Built the high-resolution 6K TV wall for high-density scientific data demonstration, including RAID hard drive mirror backup, clone hard drive DD, system assemble, troubleshoot, and VNC software key-pair.}
        \resumeItemListEnd
