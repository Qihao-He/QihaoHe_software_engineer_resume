...
\resumeSubHeadingListStart
    ...
    {Applying equations to physical modeling simulation including: projectiles, orbits, Simple Harmonic Oscillator (SHO), Maxima, Molecules. Familiar with algebraic manipulation of equations, integration and differentiation of functions, and differential equations.}
